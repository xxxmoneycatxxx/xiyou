...
$sql1 = "insert into $q2 (wjid,zbid,zbxj,zbk1,zbxq1,zbk2,zbxq2,zbk3,zbxq3,zbk4,zbxq4,zbk5,zbxq5,zbfl)  values('$wjid','$npcc10','$xvjj','$zbkk1','$zbxqq1','$zbkk2','$zbxqq2','$zbkk3','$zbxqq3','$zbkk4','$zbxqq4','$zbkk5','$zbxqq5',$cwp)";
 ...
 $q2="zb";
include("./sql/mysql.php");//调用数据库连接
$strsql = "delete from $q2 where wjid=$wjid and id=$xnpcc ";//物品id号必改值
$result = mysql_query($strsql);
$sql1 = "insert into $q2 (wjid,zbid,zbxj,zbk1,zbxq1,zbk2,zbxq2,zbk3,zbxq3,zbk4,zbxq4,zbk5,zbxq5,zbpd)  values('$wjid','$snpcc','$sxvjj','$szbkk1','$szbxqq1','$szbkk2','$szbxqq2','$szbkk3','$szbxqq3','$szbkk4','$szbxqq4','$szbkk5','$szbxqq5','0')";
 if (!mysql_query($sql1,$conn))
 {
   die('Error: ' . mysql_error());
 }	
...
include("./sql/mysql.php");//调用数据库连接
 ...
 $sql1 = "insert into $q2 (wjid,zbid,zbxj,zbk1,zbxq1,zbk2,zbxq2,zbk3,zbxq3,zbk4,zbxq4,zbk5,zbxq5,zbfl)  values('$wjid','$snpcc','$xvjj','$zbkk1','$zbxqq1','$zbkk2','$zbxqq2','$zbkk3','$zbxqq3','$zbkk4','$zbxqq4','$zbkk5','$zbxqq5',$cwp)";
 if (!mysql_query($sql1,$conn))
 {
   die('Error: ' . mysql_error());
 }	
