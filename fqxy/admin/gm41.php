...
echo "<font color=red>确定要向【全服所有玩家】发放".$wpmz."x".$wpsl."吗？</font>"."<br>";


echo "<a href='gm.php?wjid=$wjiddd&&pass=$password&&gid=42&&user=$wjid&&wpid=$wpid&&wpsl=$wpsl&&wpmz=$wpmz&&wjname=$wjname&&wpfl=$wpfl'><font color=blue>是的~~我确认</font></a>"."<br>";
echo "<a href='gm.php?wjid=$wjiddd&&pass=$password&&gid=40&&user=$wjid'><font color=blue>不~~我点错了</font></a>"."<br>";


} else{
echo "<font color=red>你输入的物品ID有误请重新输入（没有数据）</font>"."<br>";
echo "<a href='gm.php?wjid=$wjiddd&&pass=$password&&gid=40&&user=$wjid'><font color=blue>返回重新输入</font></a>"."<br>";
}
} else{
